...
class CardGenerator:
    ...
    def _build_prompt(
        ...
        full_prompt += ", ((ornate TCG card border:1.8)), ((decorative frame border:1.7)), ((intricate mystical border pattern:1.6)), arcane tribal border design"
        full_prompt += f", border color matching {color_palette.lower()} theme"
        full_prompt += ", high quality, detailed, professional artwork, card game art, TCG style, sharp focus, vibrant colors, ((Masterpiece:1.5))"
